...
package com.bmstu.notifications.manager.core.service.persistence.impl;

import aQute.bnd.annotation.ProviderType;

import com.bmstu.notifications.manager.core.exception.NoSuchNotificationException;
import com.bmstu.notifications.manager.core.model.Notification;
import com.bmstu.notifications.manager.core.model.impl.NotificationImpl;
import com.bmstu.notifications.manager.core.model.impl.NotificationModelImpl;
import com.bmstu.notifications.manager.core.service.persistence.NotificationPersistence;
 ...
 * @see com.bmstu.notifications.manager.core.service.persistence.NotificationUtil
 * @generated
 */
@ProviderType
public class NotificationPersistenceImpl extends BasePersistenceImpl<Notification>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(NotificationModelImpl.ENTITY_CACHE_ENABLED,
			NotificationModelImpl.FINDER_CACHE_ENABLED, NotificationImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(NotificationModelImpl.ENTITY_CACHE_ENABLED,
			...
			NotificationModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(NotificationModelImpl.ENTITY_CACHE_ENABLED,
			NotificationModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Notification findByGroupId_First(long groupId,
		OrderByComparator<Notification> orderByComparator)
		throws NoSuchNotificationException {
		Notification notification = fetchByGroupId_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public Notification fetchByGroupId_First(long groupId,
		OrderByComparator<Notification> orderByComparator) {
		List<Notification> list = findByGroupId(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Notification findByGroupId_Last(long groupId,
		OrderByComparator<Notification> orderByComparator)
		throws NoSuchNotificationException {
		Notification notification = fetchByGroupId_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public Notification fetchByGroupId_Last(long groupId,
		OrderByComparator<Notification> orderByComparator) {
		...
		List<Notification> list = findByGroupId(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Notification[] findByGroupId_PrevAndNext(long notificationId,
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(session, notification, groupId,
					orderByComparator, true);

			array[1] = notification;

			array[2] = getByGroupId_PrevAndNext(session, notification, groupId,
					orderByComparator, false);
	...
	protected Notification getByGroupId_PrevAndNext(Session session,
		Notification notification, long groupId,
		OrderByComparator<Notification> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupId(long groupId) {
		for (Notification notification : findByGroupId(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(notification);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2 = "notification.groupId = ?";
	...
	protected Notification toUnwrappedModel(Notification notification) {
		...
		notificationImpl.setUserName(notification.getUserName());
		...
		notificationImpl.setStatusByUserId(notification.getStatusByUserId());
		notificationImpl.setStatusByUserName(notification.getStatusByUserName());
		notificationImpl.setStatusDate(notification.getStatusDate());
		notificationImpl.setType(notification.getType());
		notificationImpl.setAlways(notification.isAlways());
		notificationImpl.setMail(notification.isMail());
		notificationImpl.setSms(notification.isSms());
		notificationImpl.setWeb(notification.isWeb());
		notificationImpl.setNotificationAttributes(notification.getNotificationAttributes());
